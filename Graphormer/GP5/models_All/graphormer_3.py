...
from Graphormer.GP5.modules_All.graphormer_graph_encoder import GraphormerGraphEncoder
...
class GraphormerModel(nn.Module):
    def __init__(self, config, target_type="default", mode="cls_only"):
        """
