...
dataset = SMILESDataset(csv_file="../data/train_100.csv", attn_bias_w=1.0, target_type=fixed_param_grid["target_type"][0])
test_dataset = SMILESDataset(csv_file="../data/train_100.csv", attn_bias_w=1.0, target_type=fixed_param_grid["target_type"][0])
