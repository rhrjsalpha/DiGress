...
# ✅ 실행 코드
fixed_params = create_fixed_params("../data/train_1000.csv", {}, dynamic=False)
...
dataset = SMILESDataset(csv_file="../data/train_1000.csv", attn_bias_w=1.0, target_type="ex_prob")
test_dataset = SMILESDataset(csv_file="../data/test_100.csv", attn_bias_w=1.0, target_type="ex_prob")
...
results = bayesian_optimization_botorch(
    ...
    testset_path="../data/test_100.csv",
    DATASET=dataset,
    TEST_DATASET=test_dataset,
    init_points=10,
    n_iter=30
