    ...
    def objective_function(**params):
        ...
        for key in [
            ...
            if key in merged_params:
                config_params[key] = int(merged_params[key])  # Convert to integer
            else:
        ...
        results.append({**merged_params, "val_loss": val_loss})
...
results_df.to_csv("../GridSearch/BayesianOptimization_with_merged_params.csv", index=False)
