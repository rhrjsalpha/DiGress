...
def train_model_ex_porb(
    ...
    """
    print(f"Config used during training: {config}")
    ...
    for epoch in range(num_epochs):
        ...
        weight_history["weight_ex_1"].append(weight_true[0])
        weight_history["weight_ex_2"].append(weight_true[1])
        weight_history["weight_prob_1"].append(weight_true[2])
        weight_history["weight_prob_2"].append(weight_true[3])
...
if __name__ == "__main__":
    ...
    loss_functions_ex_2 = ["MAE"]
    loss_functions_prob_1 = ["SoftDTW"]
    loss_functions_prob_2 = ["MAE"]
